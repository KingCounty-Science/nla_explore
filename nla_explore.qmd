...
# tsi <- left_join(tsi.chla,tsi.tp,by=c("Lake","Type","SiteName"))
# tsi <- left_join(tsi,tsi.tn,by=c("Lake","Type","SiteName"))
# tsi <- left_join(tsi,tsi.secchi,by=c("Lake","Type","SiteName"))
